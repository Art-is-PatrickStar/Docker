...
echo "master:"
docker exec -it redis-master redis-cli -a root info Replication | grep role
echo "slave1:"
docker exec -it redis-slave1 redis-cli -a root info Replication | grep role
echo "slave2:"
docker exec -it redis-slave2 redis-cli -a root info Replication | grep role